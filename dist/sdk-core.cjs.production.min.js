    ...
    return (
      ...
      (r.toSignificant = function(t, r, n) {
        void 0 === r && (r = { groupSeparator: '' }),
          ...
          t > 0 || o(!1),
          E.set({ precision: t + 1, rounding: N[n] })
      ...
      (r.toFixed = function(t, r, n) {
        return (
          ...
          (I.DP = t),
          (I.RM = R[n]),
          new I(this.numerator.toString()).div(this.denominator.toString()).toFormat(t, r)
        )
      }),
      p(t, [
        {
...
var O,
  U = (function(t) {
    ...
    return (
      (n.add = function(r) {
        return w(t.prototype.add.call(this, r))
      }),
      (n.subtract = function(r) {
        return w(t.prototype.subtract.call(this, r))
      }),
      (n.multiply = function(r) {
        return w(t.prototype.multiply.call(this, r))
      }),
      (n.divide = function(r) {
        return w(t.prototype.divide.call(this, r))
      }),
      (n.toSignificant = function(r, n, e) {
...
var D = (function(t) {
  ...
  b =
    (((O = {})[exports.ChainId.MAINNET] = new D(
    ...
    (O[exports.ChainId.ROPSTEN] = new D(
    ...
    (O[exports.ChainId.RINKEBY] = new D(
...
;(exports.CurrencyAmount = F),
  ...
  (exports.sqrt = function(t) {
    if ((i.greaterThanOrEqual(t, B) || o(!1), i.lessThan(t, q))) return i.BigInt(Math.floor(Math.sqrt(i.toNumber(t))))
    var r, n
    for (r = t, n = i.add(i.divide(t, W), S); i.lessThan(n, r); ) (r = n), (n = i.divide(i.add(i.divide(t, n), n), W))
    return r
  }),
